 ...
 */
BOOL guac_rdp_glyph_draw(rdpContext* context,const rdpGlyph* glyph, UINT32 x, UINT32 y, UINT32 w, UINT32 h,
...
BOOL guac_rdp_glyph_begindraw(rdpContext* context,
        UINT32 x, UINT32 y, UINT32 width, UINT32 height, UINT32 fgcolor, UINT32 bgcolor, BOOL fOpRedundant);
